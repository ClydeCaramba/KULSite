...
class cbInstallerPlugin extends cbInstaller
{
	...
	public function install( $fromDirectory = null, $InstallIntoDatabaseOnly = false )
	{
		...
		$THISCBVERSION			=	'2.3.0';               // IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change 2 times in CBLib.php, the 8 XML installation files and build.xml
