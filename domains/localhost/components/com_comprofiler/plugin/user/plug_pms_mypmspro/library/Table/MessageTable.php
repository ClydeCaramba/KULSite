...
class MessageTable extends Table
{
		...
		if ( ! $new ) {
			...
			if ( $notify && $this->get( 'to_user', 0, GetterInterface::INT ) ) {
				...
				if ( ( $notify == 1 ) || ( ( $notify == 2 ) && ( ! $this->get( 'reply_to', 0, GetterInterface::INT ) ) ) || ( ( $notify == 3 ) && $this->get( 'reply_to', 0, GetterInterface::INT ) ) ) {
					...
					$cbNotification->sendFromSystem( $this->get( 'to_user', 0, GetterInterface::INT ), $subject, $message, false, 1, null, null, null, array(), true, PMSHelper::getGlobalParams()->get( 'messages_notify_from_name', null, GetterInterface::STRING ), PMSHelper::getGlobalParams()->get( 'messages_notify_from_email', null, GetterInterface::STRING ) );
				}
			}
		}
	...
	{
		if ( PMSHelper::getGlobalParams()->get( 'messages_editor', 2, GetterInterface::INT ) == 2 ) {
