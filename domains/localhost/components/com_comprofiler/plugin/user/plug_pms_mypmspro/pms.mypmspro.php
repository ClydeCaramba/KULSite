...
class getmypmsproTab extends cbPMSHandler
{
	...
	public function sendUserPMS( $toUserId, $fromUserId, $subject, $message, $systemGenerated = false, $fromName = null, $fromEmail = null )
	{
		...
		if ( ( ! $fromUserId ) && ( ! $systemGenerated ) && ( $fromName || $fromEmail ) ) {
			if ( ! PMSHelper::getGlobalParams()->get( 'messages_public', false, GetterInterface::BOOLEAN ) ) {
	...
	public function getPMScapabilites()
	{
		...
		return array( 'subject' => false, 'body' => true, 'public' => PMSHelper::getGlobalParams()->get( 'messages_public', false, GetterInterface::BOOLEAN ) );
	}
	...
	public function getDisplayTab( $tab, $user, $ui )
	{
		...
		if ( ( ( ! $viewer->get( 'id', 0, GetterInterface::INT ) ) && ( ! $allowPublic ) ) || ( ! $user->get( 'id', 0, GetterInterface::INT ) ) || ( $viewer->get( 'id', 0, GetterInterface::INT ) == $user->get( 'id', 0, GetterInterface::INT ) ) ) {
			return null;
		}
