...
<div class="<?php echo ( $type == 'modal' ? 'd-flex flex-column h-100 mh-100 ' : null ); ?>pmMessages pmMessagesDefault">
	...
	<div class="<?php echo ( $type == 'modal' ? 'm-2 flex-shrink-0' : 'mb-2' ); ?> row no-gutters pkbHeader pmMessagesHeader">
		<div class="col-sm text-center text-sm-left">
			<button type="button" onclick="window.location.href='<?php echo $_CB_framework->pluginClassUrl( $this->element, true, array( 'action' => 'message', 'func' => 'new', 'return' => $returnUrl ) ); ?>';" class="btn<?php echo ( $type == 'modal' ? ' btn-sm' : null ); ?> btn-sm-block btn-success pmButton pmButtonNew"><span class="fa fa-plus-circle"></span> <?php echo CBTxt::T( 'New Message' ); ?></button>
		...
		<div class="col-sm-6 mt-1 mt-sm-0 text-sm-right" role="search">
			<form action="<?php echo $_CB_framework->pluginClassUrl( $this->element, true, array( 'action' => 'messages' ) ); ?>" method="post" name="pmMessagesForm" class="m-0 pmMessagesForm">
